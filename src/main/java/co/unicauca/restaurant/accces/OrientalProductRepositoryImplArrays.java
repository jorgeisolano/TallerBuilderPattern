...
public class OrientalProductRepositoryImplArrays implements IProductRepository {

    public static List<Product> products;
    public OrientalProductRepositoryImplArrays(){
        products = new ArrayList<>();
        initialize();
    }
    
    private void initialize() {
        products.add(new Product(1, "Chop Suey", 5000d));
        products.add(new Product(2, "Arroz ", 5500d));
